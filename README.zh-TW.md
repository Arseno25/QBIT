...
**裝置設定選單**
長按觸控感測器進入設定選單。單擊可捲動選項，長按可進入/切換：

| 設定項目 | 說明 |
|---|---|
| GIF Sound | 啟用或停用動畫播放時的蜂鳴器音效 |
| Negative GIF | 反轉所有動畫的像素顏色 |
| Flip Mode | 將螢幕旋轉 180°，適合不同安裝方向 |
| 24h Clock | 切換 24 小時制與 12 小時制顯示 |
...
**靜音 / 音效切換**
- 長按進入設定選單，找到 **GIF Sound** 並切換為 ON 或 OFF
- 選擇 **Save** 後設定才會生效
